...
export default function TOC() {
  ...
  return (
    <Nav variant="pills" id="wd-toc">
     ...
     <Nav.Item>
       <Nav.Link href="https://github.com/shahjwal/kambaz-react-web-app">My GitHub Frontend</Nav.Link>
     </Nav.Item>
     <Nav.Item>
       <Nav.Link href="https://github.com/shahjwal/kambaz-node-server-app">My GitHub Backend</Nav.Link>
     </Nav.Item>
     <Nav.Item>
